...
System prompt support across both agent adapters (Claude, Codex) and custom orchestrator scaffolding (`beat orchestrate init` + `InitCustomOrchestrator` MCP tool). Includes database migration v23.
