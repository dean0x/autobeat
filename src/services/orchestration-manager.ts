...
export class OrchestrationManagerService implements OrchestrationService {
   ...
   * function without the default system prompt. For full custom orchestrators, prefer
   * InitCustomOrchestrator which provides instruction snippets (from orchestrator-prompt.ts
   * snippet builders) + state file scaffolding.
   */
